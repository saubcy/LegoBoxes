...
public class AsynFolderDownloader extends Thread {
	...
	protected String getNameFromGoogle(String line) {
		String name = null;
		line = line.trim();
	...
	protected String getNameFromGithub(String line) {
		String name = null;
		line = line.trim();
		if(line.startsWith("<li") == false) {
			return name;
